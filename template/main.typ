...
Touying 取自中文里的「投影」，在英文中意为 project。相较而言，LaTeX 中的 beamer 就是德文的投影仪的意思。@thelegendofjiang
...
#slide[
  - 您可以使用：
    ```sh
    typst init @preview/touying-simpl-sjtu
    ```
    来创建基于本模板的演示文稿项目。

  - 本模板仓库位于 #link("https://github.com/sjtug/touying-sjtu")，欢迎关注与贡献。
]
